...
{
    uint8 staticBits = (DebugPin1_DR & (uint8)(~DebugPin1_MASK));
    DebugPin1_DR = staticBits | ((uint8)(value << DebugPin1_SHIFT) & DebugPin1_MASK);
}
...
{
	CyPins_SetPinDriveMode(DebugPin1_0, mode);
}
...
{
    return (DebugPin1_PS & DebugPin1_MASK) >> DebugPin1_SHIFT;
}
...
{
    return (DebugPin1_DR & DebugPin1_MASK) >> DebugPin1_SHIFT;
}
...
/* If Interrupts Are Enabled for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
        return (DebugPin1_INTSTAT & DebugPin1_MASK) >> DebugPin1_SHIFT;
    }
