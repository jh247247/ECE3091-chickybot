...
// CapSense_Simple(CY_COMPONENT_NAME=CapSense_Simple, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=CsBtns, CY_INSTANCE_SHORT_NAME=CsBtns, CY_MAJOR_VERSION=0, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.2 SP1, INSTANCE_NAME=CsBtns, )
module CapSense_Simple_1 (
    clk,
    B0,
    B1);
    input       clk;
...
`include "..\FIFO\FIFO.v"
`else
`define CY_BLK_DIR "C:\Users\Nick\Dropbox\Uni Docs\y4s2\ECE3091 - Engineering Design\PSoc Creator\eng_design_2015\ECE3091-chickybot\chickybot.cydsn\FIFO"
`include "C:\Users\Nick\Dropbox\Uni Docs\y4s2\ECE3091 - Engineering Design\PSoc Creator\eng_design_2015\ECE3091-chickybot\chickybot.cydsn\FIFO\FIFO.v"
`endif
...
module ADC_SAR_v3_0_7 (
	...
	cy_clock_v1_0
		#(.id("e5f82257-8eb6-47fa-9323-ca98d290efd9/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpFB_0__LedRed_net;
	wire [0:0] tmpIO_0__LedRed_net;
	wire [0:0] tmpINTERRUPT_0__LedRed_net;
	electrical [0:0] tmpSIOVREF__LedRed_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		LedRed
		 (.oe(tmpOE__LedRed_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LedRed_net[0:0]}),
		  .io({tmpIO_0__LedRed_net[0:0]}),
		  .siovref(tmpSIOVREF__LedRed_net),
		  .interrupt({tmpINTERRUPT_0__LedRed_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LedRed_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LedGreen_net;
	wire [0:0] tmpFB_0__LedGreen_net;
	wire [0:0] tmpIO_0__LedGreen_net;
	wire [0:0] tmpINTERRUPT_0__LedGreen_net;
	electrical [0:0] tmpSIOVREF__LedGreen_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("97b7bf75-ddb9-462b-8101-df5290e2fead"),
		  ...
		  .input_buffer_sel(2'b00))
		LedGreen
		 (.oe(tmpOE__LedGreen_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LedGreen_net[0:0]}),
		  .io({tmpIO_0__LedGreen_net[0:0]}),
		  .siovref(tmpSIOVREF__LedGreen_net),
		  .interrupt({tmpINTERRUPT_0__LedGreen_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LedGreen_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LedBlue_net;
	wire [0:0] tmpFB_0__LedBlue_net;
	wire [0:0] tmpIO_0__LedBlue_net;
	wire [0:0] tmpINTERRUPT_0__LedBlue_net;
	electrical [0:0] tmpSIOVREF__LedBlue_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("bf413c10-7b2f-4d42-97f4-64df5273e331"),
		  ...
		  .input_buffer_sel(2'b00))
		LedBlue
		 (.oe(tmpOE__LedBlue_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LedBlue_net[0:0]}),
		  .io({tmpIO_0__LedBlue_net[0:0]}),
		  .siovref(tmpSIOVREF__LedBlue_net),
		  .interrupt({tmpINTERRUPT_0__LedBlue_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LedBlue_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LedYellow_net;
	wire [0:0] tmpFB_0__LedYellow_net;
	wire [0:0] tmpIO_0__LedYellow_net;
	wire [0:0] tmpINTERRUPT_0__LedYellow_net;
	electrical [0:0] tmpSIOVREF__LedYellow_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("7c73f139-be8f-408d-ace1-10dee0c2561f"),
		  ...
		  .input_buffer_sel(2'b00))
		LedYellow
		 (.oe(tmpOE__LedYellow_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LedYellow_net[0:0]}),
		  .io({tmpIO_0__LedYellow_net[0:0]}),
		  .siovref(tmpSIOVREF__LedYellow_net),
		  .interrupt({tmpINTERRUPT_0__LedYellow_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LedYellow_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CapSense_Simple_1 CsBtns (
        .clk(Net_21),
        .B0(Net_22),
        .B1(Net_23));

	wire [0:0] tmpOE__LcdE_net;
	wire [0:0] tmpFB_0__LcdE_net;
	wire [0:0] tmpIO_0__LcdE_net;
	wire [0:0] tmpINTERRUPT_0__LcdE_net;
	electrical [0:0] tmpSIOVREF__LcdE_net;
	...
	cy_psoc3_pins_v1_10
		...
		LcdE
		 (.oe(tmpOE__LcdE_net),
		  .y({Net_40}),
		  .fb({tmpFB_0__LcdE_net[0:0]}),
		  .io({tmpIO_0__LcdE_net[0:0]}),
		  .siovref(tmpSIOVREF__LcdE_net),
		  .interrupt({tmpINTERRUPT_0__LcdE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LcdE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CharLCDmp_v1_2_2 Lcd (
        .RS(Net_39),
        .E(Net_40),
        .DB4(Net_41),
        .DB5(Net_42),
	...
	wire [0:0] tmpOE__LcdDB5_net;
	wire [0:0] tmpFB_0__LcdDB5_net;
	wire [0:0] tmpIO_0__LcdDB5_net;
	wire [0:0] tmpINTERRUPT_0__LcdDB5_net;
	electrical [0:0] tmpSIOVREF__LcdDB5_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8b67fde1-bd69-4d19-998f-759a15eeb53c"),
		  ...
		  .input_buffer_sel(2'b00))
		LcdDB5
		 (.oe(tmpOE__LcdDB5_net),
		  .y({Net_42}),
		  .fb({tmpFB_0__LcdDB5_net[0:0]}),
		  .io({tmpIO_0__LcdDB5_net[0:0]}),
		  .siovref(tmpSIOVREF__LcdDB5_net),
		  .interrupt({tmpINTERRUPT_0__LcdDB5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LcdDB5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LcdDB4_net;
	wire [0:0] tmpFB_0__LcdDB4_net;
	wire [0:0] tmpIO_0__LcdDB4_net;
	wire [0:0] tmpINTERRUPT_0__LcdDB4_net;
	electrical [0:0] tmpSIOVREF__LcdDB4_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1ce33345-5394-4f95-8b04-ac30f7893c2e"),
		  ...
		  .input_buffer_sel(2'b00))
		LcdDB4
		 (.oe(tmpOE__LcdDB4_net),
		  .y({Net_41}),
		  .fb({tmpFB_0__LcdDB4_net[0:0]}),
		  .io({tmpIO_0__LcdDB4_net[0:0]}),
		  .siovref(tmpSIOVREF__LcdDB4_net),
		  .interrupt({tmpINTERRUPT_0__LcdDB4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LcdDB4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__LcdRS_net;
	wire [0:0] tmpFB_0__LcdRS_net;
	wire [0:0] tmpIO_0__LcdRS_net;
	wire [0:0] tmpINTERRUPT_0__LcdRS_net;
	electrical [0:0] tmpSIOVREF__LcdRS_net;
	...
	cy_psoc3_pins_v1_10
		...
		LcdRS
		 (.oe(tmpOE__LcdRS_net),
		  .y({Net_39}),
		  .fb({tmpFB_0__LcdRS_net[0:0]}),
		  .io({tmpIO_0__LcdRS_net[0:0]}),
		  .siovref(tmpSIOVREF__LcdRS_net),
		  .interrupt({tmpINTERRUPT_0__LcdRS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LcdRS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__LcdDB6_net;
	wire [0:0] tmpFB_0__LcdDB6_net;
	wire [0:0] tmpIO_0__LcdDB6_net;
	wire [0:0] tmpINTERRUPT_0__LcdDB6_net;
	electrical [0:0] tmpSIOVREF__LcdDB6_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1bd26786-b451-4849-a074-f1b0048568db"),
		  ...
		  .input_buffer_sel(2'b00))
		LcdDB6
		 (.oe(tmpOE__LcdDB6_net),
		  .y({Net_43}),
		  .fb({tmpFB_0__LcdDB6_net[0:0]}),
		  .io({tmpIO_0__LcdDB6_net[0:0]}),
		  .siovref(tmpSIOVREF__LcdDB6_net),
		  .interrupt({tmpINTERRUPT_0__LcdDB6_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LcdDB6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LcdDB7_net;
	wire [0:0] tmpFB_0__LcdDB7_net;
	wire [0:0] tmpIO_0__LcdDB7_net;
	wire [0:0] tmpINTERRUPT_0__LcdDB7_net;
	electrical [0:0] tmpSIOVREF__LcdDB7_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8ac96e20-fc3c-477e-bd61-977fa02b3bf0"),
		  ...
		  .input_buffer_sel(2'b00))
		LcdDB7
		 (.oe(tmpOE__LcdDB7_net),
		  .y({Net_44}),
		  .fb({tmpFB_0__LcdDB7_net[0:0]}),
		  .io({tmpIO_0__LcdDB7_net[0:0]}),
		  .siovref(tmpSIOVREF__LcdDB7_net),
		  .interrupt({tmpINTERRUPT_0__LcdDB7_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LcdDB7_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LcdV0_net;
	wire [0:0] tmpFB_0__LcdV0_net;
	wire [0:0] tmpIO_0__LcdV0_net;
	wire [0:0] tmpINTERRUPT_0__LcdV0_net;
	electrical [0:0] tmpSIOVREF__LcdV0_net;
	...
	cy_psoc3_pins_v1_10
		...
		LcdV0
		 (.oe(tmpOE__LcdV0_net),
		  .y({Net_45}),
		  .fb({tmpFB_0__LcdV0_net[0:0]}),
		  .io({tmpIO_0__LcdV0_net[0:0]}),
		  .siovref(tmpSIOVREF__LcdV0_net),
		  .interrupt({tmpINTERRUPT_0__LcdV0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LcdV0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__PWDN_net;
	wire [0:0] tmpFB_0__PWDN_net;
	wire [0:0] tmpIO_0__PWDN_net;
	wire [0:0] tmpINTERRUPT_0__PWDN_net;
	electrical [0:0] tmpSIOVREF__PWDN_net;
	...
	cy_psoc3_pins_v1_10
		...
		PWDN
		 (.oe(tmpOE__PWDN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PWDN_net[0:0]}),
		  .io({tmpIO_0__PWDN_net[0:0]}),
		  .siovref(tmpSIOVREF__PWDN_net),
		  .interrupt({tmpINTERRUPT_0__PWDN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWDN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__UsTrig_net;
	wire [0:0] tmpFB_0__UsTrig_net;
	wire [0:0] tmpIO_0__UsTrig_net;
	wire [0:0] tmpINTERRUPT_0__UsTrig_net;
	electrical [0:0] tmpSIOVREF__UsTrig_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("71759e4d-8b9e-4a86-889f-5e0f535e3a01"),
		  ...
		  .input_buffer_sel(2'b00))
		UsTrig
		 (.oe(tmpOE__UsTrig_net),
		  .y({Net_657}),
		  .fb({tmpFB_0__UsTrig_net[0:0]}),
		  .io({tmpIO_0__UsTrig_net[0:0]}),
		  .siovref(tmpSIOVREF__UsTrig_net),
		  .interrupt({tmpINTERRUPT_0__UsTrig_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__UsTrig_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__ElbowPos_net;
	wire [0:0] tmpFB_0__ElbowPos_net;
	wire [0:0] tmpIO_0__ElbowPos_net;
	wire [0:0] tmpINTERRUPT_0__ElbowPos_net;
	electrical [0:0] tmpSIOVREF__ElbowPos_net;
	...
	cy_psoc3_pins_v1_10
		...
		ElbowPos
		 (.oe(tmpOE__ElbowPos_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__ElbowPos_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ElbowPos_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ElbowNeg_net;
	wire [0:0] tmpFB_0__ElbowNeg_net;
	wire [0:0] tmpIO_0__ElbowNeg_net;
	wire [0:0] tmpINTERRUPT_0__ElbowNeg_net;
	electrical [0:0] tmpSIOVREF__ElbowNeg_net;
	...
	cy_psoc3_pins_v1_10
		...
		ElbowNeg
		 (.oe(tmpOE__ElbowNeg_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__ElbowNeg_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ElbowNeg_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ShoulderPos_net;
	wire [0:0] tmpFB_0__ShoulderPos_net;
	wire [0:0] tmpIO_0__ShoulderPos_net;
	wire [0:0] tmpINTERRUPT_0__ShoulderPos_net;
	electrical [0:0] tmpSIOVREF__ShoulderPos_net;
	...
	cy_psoc3_pins_v1_10
		...
		ShoulderPos
		 (.oe(tmpOE__ShoulderPos_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__ShoulderPos_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ShoulderPos_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ShoulderNeg_net;
	wire [0:0] tmpFB_0__ShoulderNeg_net;
	wire [0:0] tmpIO_0__ShoulderNeg_net;
	wire [0:0] tmpINTERRUPT_0__ShoulderNeg_net;
	electrical [0:0] tmpSIOVREF__ShoulderNeg_net;
	...
	cy_psoc3_pins_v1_10
		...
		ShoulderNeg
		 (.oe(tmpOE__ShoulderNeg_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__ShoulderNeg_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	wire [0:0] tmpIO_0__ElbowPot_net;
	wire [0:0] tmpINTERRUPT_0__ElbowPot_net;
	electrical [0:0] tmpSIOVREF__ElbowPot_net;
	...
	assign tmpOE__ElbowPot_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    Timer_v2_70_6 UsTimer (
        .reset(Net_12),
        .interrupt(Net_1403),
        .enable(1'b1),
        .trigger(Net_1406),
        .capture(Net_1406),
        .capture_out(Net_1407),
        .tc(Net_1408),
        .clock(Net_10));
    defparam UsTimer.CaptureCount = 2;
    defparam UsTimer.CaptureCounterEnabled = 0;
    defparam UsTimer.DeviceFamily = "PSoC5";
    defparam UsTimer.InterruptOnCapture = 1;
    defparam UsTimer.InterruptOnTC = 0;
    defparam UsTimer.Resolution = 16;
    defparam UsTimer.SiliconRevision = "0";
	...
	wire [0:0] tmpINTERRUPT_0__UsEcho_net;
	electrical [0:0] tmpSIOVREF__UsEcho_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		UsEcho
		 (.oe(tmpOE__UsEcho_net),
		  .y({1'b0}),
		  .fb({Net_1406}),
		  .io({tmpIO_0__UsEcho_net[0:0]}),
		  .siovref(tmpSIOVREF__UsEcho_net),
		  .interrupt({tmpINTERRUPT_0__UsEcho_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	wire [0:0] tmpOE__MicroSwitch_net;
	wire [0:0] tmpIO_0__MicroSwitch_net;
	wire [0:0] tmpINTERRUPT_0__MicroSwitch_net;
	electrical [0:0] tmpSIOVREF__MicroSwitch_net;

	cy_psoc3_pins_v1_10
		#(.id("0cfd2043-6061-429d-85ff-ef375b507b3b"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		MicroSwitch
		 (.oe(tmpOE__MicroSwitch_net),
		  .y({1'b0}),
		  .fb({Net_1513}),
		  .io({tmpIO_0__MicroSwitch_net[0:0]}),
		  .siovref(tmpSIOVREF__MicroSwitch_net),
		  .interrupt({tmpINTERRUPT_0__MicroSwitch_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MicroSwitch_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Fan_net;
	wire [0:0] tmpFB_0__Fan_net;
	wire [0:0] tmpIO_0__Fan_net;
	wire [0:0] tmpINTERRUPT_0__Fan_net;
	electrical [0:0] tmpSIOVREF__Fan_net;

	cy_psoc3_pins_v1_10
		#(.id("4a5d3763-f791-406e-a1ee-ae1a6ba93031"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Fan
		 (.oe(tmpOE__Fan_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Fan_net[0:0]}),
		  .io({tmpIO_0__Fan_net[0:0]}),
		  .siovref(tmpSIOVREF__Fan_net),
		  .interrupt({tmpINTERRUPT_0__Fan_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Fan_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
