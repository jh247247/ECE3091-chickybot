...
module top ;
	...
	wire [0:0] tmpOE__RotateCCW_net;
	wire [0:0] tmpFB_0__RotateCCW_net;
	wire [0:0] tmpIO_0__RotateCCW_net;
	wire [0:0] tmpINTERRUPT_0__RotateCCW_net;
	electrical [0:0] tmpSIOVREF__RotateCCW_net;

	cy_psoc3_pins_v1_10
		#(.id("54f9983f-2b6e-4ceb-9f3b-6cd764a3fb91"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RotateCCW
		 (.oe(tmpOE__RotateCCW_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RotateCCW_net[0:0]}),
		  .io({tmpIO_0__RotateCCW_net[0:0]}),
		  .siovref(tmpSIOVREF__RotateCCW_net),
		  .interrupt({tmpINTERRUPT_0__RotateCCW_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RotateCCW_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RotateCW_net;
	wire [0:0] tmpFB_0__RotateCW_net;
	wire [0:0] tmpIO_0__RotateCW_net;
	wire [0:0] tmpINTERRUPT_0__RotateCW_net;
	electrical [0:0] tmpSIOVREF__RotateCW_net;

	cy_psoc3_pins_v1_10
		#(.id("fbc6b70f-30cd-48d2-a4b7-caf9fc5ca853"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RotateCW
		 (.oe(tmpOE__RotateCW_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RotateCW_net[0:0]}),
		  .io({tmpIO_0__RotateCW_net[0:0]}),
		  .siovref(tmpSIOVREF__RotateCW_net),
		  .interrupt({tmpINTERRUPT_0__RotateCW_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RotateCW_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
