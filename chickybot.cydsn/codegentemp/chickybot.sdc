...
# Date: Tue, 15 Sep 2015 23:16:54 GMT
#set_units -time ns
...
create_clock -name {ClockLcdBacklight(routed)} -period 100000 -waveform {0 50000} [list [get_pins {ClockBlock/dclk_4}]]
...
create_generated_clock -name {ClockLcdBacklight} -source [get_pins {ClockBlock/clk_sync}] -edges {1 2401 4801} [list [get_pins {ClockBlock/dclk_glb_4}]]
...
# Project: C:\Users\Nick\Dropbox\Uni Docs\y4s2\ECE3091 - Engineering Design\PSoc Creator\eng_design_2015\ECE3091-chickybot\chickybot.cydsn\chickybot.cyprj
# Date: Tue, 15 Sep 2015 23:16:45 GMT
