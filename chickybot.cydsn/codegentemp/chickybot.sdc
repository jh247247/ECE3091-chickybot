...
# Date: Wed, 23 Sep 2015 04:18:40 GMT
#set_units -time ns
...
create_clock -name {ClockLcdBacklight(routed)} -period 100000 -waveform {0 50000} [list [get_pins {ClockBlock/dclk_2}]]
...
create_generated_clock -name {ClockLcdBacklight} -source [get_pins {ClockBlock/clk_sync}] -edges {1 2401 4801} [list [get_pins {ClockBlock/dclk_glb_2}]]
...
# Project: C:\Users\Nick\Dropbox\Uni Docs\y4s2\ECE3091 - Engineering Design\PSoc Creator\eng_design_2015\ECE3091-chickybot\chickybot.cydsn\chickybot.cyprj
# Date: Wed, 23 Sep 2015 04:18:31 GMT
