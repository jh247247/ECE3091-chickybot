...
const unsigned char `$INSTANCE_NAME`_settings[][2] = {
...
const unsigned char `$INSTANCE_NAME`_format[] = {
	0x12, 0x0c, 0x0d, 0x17, 0x18, 0x32, 0x19, 0x1a, 0x03,
	0x37, 0x38, 0x39,0xff
};

const unsigned char `$INSTANCE_NAME`_sxga[] = {
	0x00, 0x00, 0x00, 0x1d, 0xbd, 0xbf, 0x01, 0x81, 0x12,
	0x81, 0x93, 0x51,
};

const unsigned char `$INSTANCE_NAME`_vga[] = {
	0x40, 0x04, 0x80, 0x26, 0xc6, 0xed, 0x01, 0x3d, 0x00,
	0x91, 0x12, 0x43,
};

const unsigned char `$INSTANCE_NAME`_qvga[] = {
	0x10, 0x04, 0x80, 0x26, 0xc6, 0xed, 0x00, 0x1e, 0x36,
	0x91, 0x12, 0x43,
};

const unsigned char `$INSTANCE_NAME`_cif[] = {
	0x20, 0x04, 0x80, 0x28, 0x80, 0xed, 0x00, 0x24, 0x36,
	0x91, 0x12, 0x43,
};

const unsigned char `$INSTANCE_NAME`_qcif[] = {
